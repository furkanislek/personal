...
Aşağıdaki ortam değişkenlerini `.env.local` dosyasında yapılandırın:
...
4. API anahtarlarınızı `.env.local` dosyasına ekleyin
...
Proje Next.js kullandığı için şu platformlarda da deploy edilebilir:
